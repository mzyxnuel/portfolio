		...
		<div className="py-24 my-auto">
			<main className="">
				<div className="flex items-center justify-center gap-3">
					{/* TODO */}
					<div className="flex items-center justify-center pt-1 rounded-full w-11 h-11 bg-snow lg:w-16 lg:h-16 md:pt-2">
						{/* Memoji */}
						<Image
							alt="memoji"
							width="60"
							height="50"
							className="rounded-full w-11 h-11 lg:w-14 lg:h-14"
							src={ImagePath}
						/>
					</div>
					<div className="p-2 pl-4 pr-4 border rounded-full border-bline lg:py-4">
						{/* Hero */}
